...
const AttendanceTable = () => {
  ...
  return (
    <div className="rounded-md border border-gray-300 mt-5 mx-5 ml-1">
      <div className="grid grid-cols-8 divide-x divide-gray-300">
        ...
        <div className="py-2 px-4 bg-gray-50 border-b border-gray-300 text-sm font-medium">Actual Time</div>
        ...
        <div className="py-2 px-4 bg-gray-50 border-b border-gray-300 text-sm font-medium">Final Att.</div>
        <div className="py-2 px-4 bg-gray-50 border-b border-gray-300 text-sm font-medium text-right">Actions</div>
      </div>

      {attendanceData[0].dailyRecords.map((day, index) => (
        <div key={index} className="grid grid-cols-8 divide-x divide-gray-300 hover:bg-gray-50">
          ...
          <div className={`py-2 px-2 border-b border-gray-300 text-sm ${getStatusColor(day.status)}`}>
            <div className="flex items-center gap-2">
